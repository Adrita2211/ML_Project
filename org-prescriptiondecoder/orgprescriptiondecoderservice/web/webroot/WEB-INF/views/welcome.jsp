...
<html lang="en">
<head>
    <title>Welcome to orgprescriptiondecoderservice</title>
    <link rel="stylesheet" href="<c:url value="/static/orgprescriptiondecoderservice-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "orgprescriptiondecoderservice" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/orgprescriptiondecoderservice-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/orgprescriptiondecoderservice-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/orgprescriptiondecoderservice-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/orgprescriptiondecoderservice-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/orgprescriptiondecoderservice-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>
