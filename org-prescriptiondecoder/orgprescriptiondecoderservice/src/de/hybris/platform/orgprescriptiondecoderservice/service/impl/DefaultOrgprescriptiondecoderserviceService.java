...
public class DefaultOrgprescriptiondecoderserviceService implements OrgprescriptiondecoderserviceService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultOrgprescriptiondecoderserviceService.class);
	...
	{
		return DefaultOrgprescriptiondecoderserviceService.class.getResourceAsStream("/orgprescriptiondecoderservice/sap-hybris-platform.png");
	}
